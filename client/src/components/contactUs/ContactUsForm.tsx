      ...
      <div className="flex flex-col w-full xl:h-[350px] justify-center xl:gap-[30%]">
        ...
        <div className="flex flex-col items-center w-full mt-7 mb-5 xl:mt-0 xl:mb-0 xl:items-start">
          ...
          >
            ...
            <Link target="_blank"
            to="https://www.instagram.com/nexusdigital.ar/" className="bg-[#b9ff66] rounded-md px-2 xl:text-lg">
              nexusdigital.ar
            </Link>
          </div>
          ...
          >
            ...
            <Link to="tel:+543329684724" className="bg-[#b9ff66] rounded-md px-2 xl:text-lg">
              +54 3329-684724
            </Link>
          </div>
          ...
          >
            ...
            <Link to="mailto:nexusdigitalcontact@gmail.com" className="bg-[#b9ff66] rounded-md px-2 xl:text-lg">
