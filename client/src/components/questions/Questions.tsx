...
const Questions = (): React.ReactElement => {
  ...
  return (
    ...
    >
      <div className="relative left-[2000px] title-animation w-full">
        <div className="h-[175px] items-center justify-center xl:justify-start flex flex-col xl:flex-row gap-[30px] xl:w-full">
          <h2 className="flex flex-col xl:flex-row items-center justify-center xl:justify-start xl:ml-10 h-[70px]">
            <span className="w-[226px] h-[46px] md:h-[66px] lg:h-[71px] rounded-[7px] xl:rounded-l-[7px] xl:rounded-none pr-[7px] pl-[7px] text-center text-[36px] lg:text-[40px] lead-[45.94px] bg-[#B9FF66] gap-[]">
              Preguntas
            </span>
            <span className="w-[240px] h-[51px] md:h-[61px] lg:h-[71px] xl:rounded-r-[7px] xl:rounded-none rounded-[7px] pr-[7px] pl-[7px] text-center text-[40px] lg:text-[44px] xl:text-[40px] lead-[51.04px] gap-[10px] bg-[#B9FF66] mb-10 xl:mb-0">
              Frecuentes
            </span>
          </h2>
          <p className="text-[16px] md:text-[18px] lg:text-[26px] xl:text-lg 2xl:text-[1.2rem] lead-[24px] text-center px-3">
      ...
      <div className="p-2 flex flex-col items-center gap-3">
        {questionsList.map((quest, index) => (
          <div
            key={quest._id}
            className={`relative w-full flex flex-col gap-3 items-center left-[2000px] animation-window-${index}`}
          >
            <div
            ...
            >
              ...
              <div
                className={`h-[120px] lg:h-[150px] w-full max-w-[1400px] rounded-[45px] border border-b-4 border-black border-solid flex flex-row items-center justify-around bg-[#F3F3F3]`}
              >
                <p className="text-[30px] md:text-[40px] lg:text-[50px] font-medium">
                  0{index + 1}
                </p>
                <p className="text-center text-[15px] md:text-[18px] lg:text-[20px] 2xl:text-[26px] w-[180px] sm:w-[400px] md:w-[450px] min-[500px]:w-[300px] lg:w-[550px] 2xl:w-[700px]">
                  {quest.question}
                </p>
                <p
            ...
            >
              <p className="text-[13px] sm:text-[16px] md:text-[18px] lg:text-[20px] 2xl:text-[22px] w-[250px] sm:w-[420px] md:w-[580px] 2xl:w-[800px] lg:w-[660px] transition-all ease-in duration-150">
                {visibleAnswers[index]?.isVisible
